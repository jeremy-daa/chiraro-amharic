        ...
        <div className="bg-black rounded-[3rem] p-8 md:p-12 relative overflow-hidden shadow-[12px_12px_0px_0px_#D4F853] border-2 border-brand-lime flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="md:w-1/2 relative z-10 text-left">
            ...
            <h2 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
              Take a Free <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-lime to-brand-blue">
                Amharic Placement Test
              </span>
            </h2>
            <p className="text-gray-400 text-lg mb-8 max-w-md">
              Find out exactly where you stand. Take our quick online competency
              test in either Amharic Fidel or English Phonetics.
            </p>
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-1">
            ...
            <p className="text-gray-600 text-sm leading-relaxed mb-6">
              ...
              the Amharic language alive and accessible globally.
            </p>
          ...
          <div>
            <h4 className="text-black font-bold mb-6 text-lg">Discover</h4>
            <ul className="space-y-3 text-gray-600">
              <li>
                <a
                  href="#home"
        ...
        <div className="border-t border-black/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-600 text-sm">
            © 2026 Chiraro Amharic. All rights reserved.
          </p>
          <p className="text-gray-600 text-sm flex items-center gap-1">
            Made with{" "}
            <Heart className="w-4 h-4 text-brand-pink fill-current animate-pulse" />{" "}
            in Addis Ababa
          </p>
        </div>
      </div>
