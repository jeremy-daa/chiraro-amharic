      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-16 xl:px-24">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Why{" "}
            <span className="inline-block bg-brand-lime px-4 py-1 rounded-full border border-black transform -rotate-1">
              Chiraro
            </span>
            ?
          </h2>
            ...
            <div className="bg-white rounded-[2rem] border border-black p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] relative overflow-hidden">
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="font-bold text-xl">
                  Learn Amharic the Fun & Effective Way
                </span>
              </div>
              <div className="space-y-6 text-gray-700 leading-relaxed text-lg">
                <p>
                  Looking to learn Amharic in a fun and effective way? At{" "}
                  <strong>Chiraro Language School</strong>, we bring years of
                  experience and a TESOL certification from Arizona State
                  University (ASU) to help students master Amharic as a second
                  language.
                </p>
                <p>
